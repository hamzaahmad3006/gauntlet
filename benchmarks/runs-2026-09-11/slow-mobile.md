...
**Run** `01a0915a-cf16-7634-bb94-c696bc6c9f74` · status **completed** · grade **C** · score **76.17**
...
|---|---|---|---|---|---|
| MET-02 Response latency p95 | 1,639.5 ms | 1500 ms (THRESHOLD) | breach | 168 | MEASURED |
| MET-04 Time to first response p50 | 1,601.314 ms | 1200 ms (THRESHOLD) | breach | 20 | MEASURED |
| MET-08 Dead-air ratio | 15.592% | 5% (THRESHOLD) | breach | 24 | MEASURED |
| - Caller fallback rate | 55.814% | — (THRESHOLD) | — | 172 | MEASURED |
| - Premature speech rate | 2.907% | — (THRESHOLD) | — | 172 | MEASURED |
| - Reconnect rate | 0% | — (THRESHOLD) | — | 24 | MEASURED |
| MET-01 Response latency p50 | 1,596.675 ms | — (THRESHOLD) | — | 168 | MEASURED |
| MET-03 Response latency p99 | 1,654.868 ms | — (THRESHOLD) | — | 168 | MEASURED |
| MET-07 Talk-over per call | 480.682 ms | 1200 ms (THRESHOLD) | pass | 24 | MEASURED |
| MET-09 Call completion rate | 100% | 97% (THRESHOLD) | pass | 24 | MEASURED |
| MET-10 Session error rate | 0% | 3% (THRESHOLD) | pass | 24 | MEASURED |
| MET-15 Degradation ratio | 1.021 ratio | 2 ratio (THRESHOLD) | pass | 1 | MEASURED |
| MET-21 Caller turnaround overhead p95 | 1.656 ms | — (THRESHOLD) | — | 172 | MEASURED |
...
|---|---|---|---|
| SC-01 Responsiveness | 58.96 | 0.3 | 0.35 |
| SC-02 Turn-taking | 68.23 | 0.25 | 0.29 |
